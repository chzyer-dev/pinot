...
public class BrokerRequest implements org.apache.thrift.TBase<BrokerRequest, BrokerRequest._Fields>, java.io.Serializable, Cloneable, Comparable<BrokerRequest> {
  ...
  private static final _Fields optionals[] = {_Fields.QUERY_TYPE,_Fields.QUERY_SOURCE,_Fields.TIME_INTERVAL,_Fields.DURATION,_Fields.FILTER_QUERY,_Fields.AGGREGATIONS_INFO,_Fields.GROUP_BY,_Fields.SELECTIONS,_Fields.FILTER_SUB_QUERY_MAP,_Fields.BUCKET_HASH_KEY,_Fields.ENABLE_TRACE};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.aggregationsInfo = new ArrayList<AggregationInfo>(_list68.size);
                AggregationInfo _elem69;
                for (int _i70 = 0; _i70 < _list68.size; ++_i70)
                {
                  _elem69 = new AggregationInfo();
                  _elem69.read(iprot);
                  struct.aggregationsInfo.add(_elem69);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.aggregationsInfo != null) {
        if (struct.isSetAggregationsInfo()) {
          oprot.writeFieldBegin(AGGREGATIONS_INFO_FIELD_DESC);
          {
            ...
            for (AggregationInfo _iter71 : struct.aggregationsInfo)
            {
              _iter71.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetAggregationsInfo()) {
        {
          ...
          for (AggregationInfo _iter72 : struct.aggregationsInfo)
          {
            _iter72.write(oprot);
          }
        }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.aggregationsInfo = new ArrayList<AggregationInfo>(_list73.size);
          AggregationInfo _elem74;
          for (int _i75 = 0; _i75 < _list73.size; ++_i75)
          {
            _elem74 = new AggregationInfo();
            _elem74.read(iprot);
            struct.aggregationsInfo.add(_elem74);
          }
        }
        struct.setAggregationsInfoIsSet(true);
      }
