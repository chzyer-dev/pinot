...
public class InstanceRequest implements org.apache.thrift.TBase<InstanceRequest, InstanceRequest._Fields>, java.io.Serializable, Cloneable, Comparable<InstanceRequest> {
  ...
  private static final _Fields optionals[] = {_Fields.SEARCH_SEGMENTS,_Fields.ENABLE_TRACE};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.searchSegments = new ArrayList<String>(_list76.size);
                String _elem77;
                for (int _i78 = 0; _i78 < _list76.size; ++_i78)
                {
                  _elem77 = iprot.readString();
                  struct.searchSegments.add(_elem77);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.searchSegments != null) {
        if (struct.isSetSearchSegments()) {
          oprot.writeFieldBegin(SEARCH_SEGMENTS_FIELD_DESC);
          {
            ...
            for (String _iter79 : struct.searchSegments)
            {
      ...
      if (struct.isSetSearchSegments()) {
        {
          ...
          for (String _iter80 : struct.searchSegments)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.searchSegments = new ArrayList<String>(_list81.size);
          String _elem82;
          for (int _i83 = 0; _i83 < _list81.size; ++_i83)
          {
            _elem82 = iprot.readString();
            struct.searchSegments.add(_elem82);
          }
        }
        struct.setSearchSegmentsIsSet(true);
      }
